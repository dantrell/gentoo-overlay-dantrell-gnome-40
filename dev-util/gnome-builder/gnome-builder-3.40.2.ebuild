...
PATCHES=(
	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/gnome-builder/-/commit/b3bfa0df53a3749c3b73cb6c4bad5cab3fa549a1
	# 	https://gitlab.gnome.org/GNOME/gnome-todo/-/issues/434
	"${FILESDIR}"/${PN}-3.40.2-build-fails-because-missing-libportal-gtk3-dependency.patch
)
